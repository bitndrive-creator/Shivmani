      ...
      <main style={{ background: '#ffffff', minHeight: '100vh', paddingTop: 72 }}>
        ...
        <section style={{
          ...
          <div style={{ position: 'relative', zIndex: 10, maxWidth: 720, margin: '0 auto' }}>
            <p style={{ fontSize: 20, letterSpacing: '0.5em', textTransform: 'uppercase', color: '#C9A84C', marginBottom: 24, fontFamily: 'sans-serif' }}>Editorial</p>
            ...
            <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.4)', fontWeight: 300, fontFamily: 'sans-serif' }}>Intelligence, trends, and stories from the world of Indian luxury.</p>
          </div>
        ...
        <section style={{ background: '#0a0a0a', padding: '80px 32px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ maxWidth: 520, margin: '0 auto' }}>
            <p style={{ fontSize: 15, letterSpacing: '0.5em', textTransform: 'uppercase', color: '#C9A84C', marginBottom: 20, fontFamily: 'sans-serif' }}>Weekly Intelligence</p>
